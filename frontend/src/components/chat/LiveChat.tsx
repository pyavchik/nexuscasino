...
export function LiveChat({ isOpen, onToggle }: LiveChatProps) {
  ...
  if (!isOpen) {
    return (
      <Button
        onClick={onToggle}
        className="fixed bottom-4 right-4 rounded-full w-14 h-14 shadow-lg bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700"
        size="icon"
      >
  ...
  return (
    <Card className="fixed bottom-4 right-4 w-96 h-[500px] flex flex-col bg-slate-900/95 backdrop-blur-xl border-slate-800 shadow-2xl">
